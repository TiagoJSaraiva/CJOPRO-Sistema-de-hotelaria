...
export type Database = {
  public: {
    Tables: {
      ...
      maintenance_occurrences: {
        Row: {
          ...
          category_id: string;
          confirmed_party:
            Database["public"]["Enums"]["maintenance_responsible_party"] | null;
          created_at: string;
          description: string;
      ...
      maintenance_work_orders: {
        Row: {
          ...
          waiting_reason:
            Database["public"]["Enums"]["maintenance_waiting_reason"] | null;
        };
        Insert: {
          assigned_to?: string | null;
          completed_at?: string | null;
      ...
      reservations: {
        Row: {
          ...
          reservation_source:
            Database["public"]["Enums"]["reservation_source"] | null;
          total_paid: number;
          updated_at: string;
        };
        Insert: {
    ...
    Enums: {
      ...
      stay_status:
        "checked_in" | "checked_out" | "no_show" | "canceled" | "confirmed";
      transaction_status:
