...
import {
  MaintenanceAffectedRoomsInputSchema,
  MaintenanceAvailabilityExceptionSchema,
  MaintenanceLifecycleActionSchema,
  MaintenanceLifecycleCreateSchema,
  MaintenancePlanningBoardSchema,
  MaintenanceRecurrenceActionSchema,
  MaintenanceRecurrencePolicyInputSchema,
  MaintenanceRescheduleDecisionSchema,
  MaintenanceRescheduleRequestSchema,
  MaintenanceScheduleInputSchema,
  MaintenanceScheduleSimulationSchema,
  MaintenanceServiceCommunicationSchema,
  MaintenanceServiceConfirmationSchema,
...
import {
  ...
  DailyCloseActionSchema,
  DailyClosePrepareSchema,
  LotActionSchema,
  LotTrackingInputSchema,
  MinibarCompositionInputSchema,
  MinibarCompositionVersionInputSchema,
  MinibarRouteInputSchema,
  OrganizationActionSchema,
  OrganizationInputSchema,
  PartnerDisputeInputSchema,
  PaymentInputSchema,
  ProcurementInvoiceInputSchema,
  ProcurementPolicyInputSchema,
  PurchaseOrderInputSchema,
  PurchaseReceiptInputSchema,
  ReplenishmentActionSchema,
  ReplenishmentRequestInputSchema,
  VersionedReasonActionSchema,
...
const MaintenanceTransitionBodySchema = Type.Object(
  {
    ...
    waiting_owner_id: Type.Optional(uuid()),
    next_follow_up_at: Type.Optional(dateTime()),
    supplier_id: Type.Optional(uuid()),
...
export const API_ROUTE_CONTRACTS: Readonly<Record<string, ApiRouteContract>> = {
  ...
  "GET /admin/maintenance/planning/board": admin(
    "getMaintenancePlanningBoard",
    "Maintenance planning",
    "Consulta agenda, capacidade e backlog priorizado do hotel ativo.",
    MaintenancePlanningBoardSchema,
    {
      querystring: Type.Object(
        { from: Type.Optional(dateTime()), to: Type.Optional(dateTime()) },
        strict,
      ),
    },
  ),
  "POST /admin/maintenance/teams": admin(
    "createMaintenanceTeam",
    "Maintenance planning",
    "Cria equipe, membros e disponibilidade semanal.",
    OkSchema,
    { body: MaintenanceTeamInputSchema },
  ),
  "PUT /admin/maintenance/teams/:id": admin(
    "updateMaintenanceTeam",
    "Maintenance planning",
    "Atualiza uma equipe com concorrência otimista.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceTeamInputSchema },
  ),
  "POST /admin/maintenance/availability-exceptions": admin(
    "createMaintenanceAvailabilityException",
    "Maintenance planning",
    "Registra ausência ou capacidade adicional com vigência.",
    OkSchema,
    { body: MaintenanceAvailabilityExceptionSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/schedule/simulate": admin(
    "simulateMaintenanceSchedule",
    "Maintenance planning",
    "Simula conflitos sem alterar a agenda.",
    itemSchema(MaintenanceScheduleSimulationSchema),
    { params: IdParamsSchema, body: MaintenanceScheduleInputSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/schedule": admin(
    "scheduleMaintenanceWorkOrder",
    "Maintenance planning",
    "Confirma o agendamento após revalidar conflitos.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceScheduleInputSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/reschedule-requests": admin(
    "requestMaintenanceReschedule",
    "Maintenance planning",
    "Solicita reagendamento da ordem atribuída ao técnico.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceRescheduleRequestSchema },
  ),
  "POST /admin/maintenance/reschedule-requests/:id/decision": admin(
    "decideMaintenanceReschedule",
    "Maintenance planning",
    "Aprova ou rejeita uma solicitação de reagendamento.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceRescheduleDecisionSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/waiting-follow-ups": admin(
    "followUpMaintenanceWaiting",
    "Maintenance quality",
    "Registra contato e próxima cobrança de uma espera ativa.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceWaitingFollowupInputSchema },
  ),
  "PUT /admin/maintenance/occurrences/:id/affected-rooms": admin(
    "updateMaintenanceAffectedRooms",
    "Maintenance quality",
    "Confirma os quartos afetados pela ocorrência.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceAffectedRoomsInputSchema },
  ),
  "GET /admin/maintenance/occurrences/:id/recurrence": admin(
    "getMaintenanceRecurrence",
    "Maintenance quality",
    "Consulta o grupo de reincidência da ocorrência.",
    Type.Object(
      {
        active: Type.Boolean(),
        group: Type.Union([
        ...
        occurrences: Type.Array(Type.Record(Type.String(), Type.Any())),
      },
      strict,
    ),
    { params: IdParamsSchema },
  ),
  "PUT /admin/maintenance/recurrence-policy": admin(
    "updateMaintenanceRecurrencePolicy",
    "Maintenance quality",
    "Atualiza a política padrão ou especializada de reincidência.",
    OkSchema,
    { body: MaintenanceRecurrencePolicyInputSchema },
  ),
  "POST /admin/maintenance/recurrence-groups/:id/actions": admin(
    "actMaintenanceRecurrenceGroup",
    "Maintenance quality",
    "Corrige, encerra ou une um grupo de reincidência com justificativa.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceRecurrenceActionSchema },
  ),
  "POST /admin/maintenance/occurrences/:id/lifecycle-decisions": admin(
    "createMaintenanceLifecycleDecision",
    "Maintenance quality",
    "Cria comparação entre reparo, substituição e garantia.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceLifecycleCreateSchema },
  ),
  "POST /admin/maintenance/lifecycle-decisions/:id/actions": admin(
    "actMaintenanceLifecycleDecision",
    "Maintenance quality",
    "Submete, aprova, rejeita, executa ou cancela a decisão.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceLifecycleActionSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/service-confirmations": admin(
    "confirmMaintenanceService",
    "Maintenance quality",
    "Registra presença, acesso ou ausência no atendimento.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceServiceConfirmationSchema },
  ),
  "POST /admin/maintenance/work-orders/:id/service-communications": admin(
    "recordMaintenanceServiceCommunication",
    "Maintenance quality",
    "Registra a previsão comunicada sem enviar mensagem externa.",
    OkSchema,
    { params: IdParamsSchema, body: MaintenanceServiceCommunicationSchema },
  ),
  "POST /admin/maintenance/planning/reconcile": admin(
    "reconcileMaintenancePlanning",
    "Maintenance planning",
    "Atualiza score e reincidências do hotel ativo.",
    OkSchema,
  ),
  "GET /admin/business-organizations": admin(
    "listBusinessOrganizations",
    "Organizations",
    "Lista organizações e seus papéis no hotel ativo.",
    Type.Array(Type.Record(Type.String(), Type.Any())),
  ),
  "GET /admin/business-organizations/:id/overview": admin(
    "getBusinessOrganizationOverview",
    "Organizations",
    "Consulta papéis e relações autorizadas de uma organização.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema },
  ),
  "POST /admin/business-organizations": admin(
    "createBusinessOrganization",
    "Organizations",
    "Cria uma organização no hotel ativo.",
    OkSchema,
    { body: OrganizationInputSchema },
  ),
  "POST /admin/business-organizations/:id/actions": admin(
    "actBusinessOrganization",
    "Organizations",
    "Consolida ou separa papéis de uma organização com auditoria.",
    OkSchema,
    { params: IdParamsSchema, body: OrganizationActionSchema },
  ),
  "GET /admin/procurement/board": admin(
    "getProcurementBoard",
    "Procurement",
    "Consulta reposições, pedidos, notas e fornecedores.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "PUT /admin/procurement/policy": admin(
    "updateProcurementPolicy",
    "Procurement",
    "Configura alçadas e tolerâncias de compra.",
    OkSchema,
    { body: ProcurementPolicyInputSchema },
  ),
  "POST /admin/procurement/replenishment-requests": admin(
    "createReplenishmentRequest",
    "Procurement",
    "Cria uma solicitação manual de reposição.",
    OkSchema,
    { body: ReplenishmentRequestInputSchema },
  ),
  "POST /admin/procurement/replenishment-requests/:id/actions": admin(
    "actReplenishmentRequest",
    "Procurement",
    "Avança uma solicitação de reposição.",
    OkSchema,
    { params: IdParamsSchema, body: ReplenishmentActionSchema },
  ),
  "POST /admin/procurement/reconcile": admin(
    "reconcileProcurement",
    "Procurement",
    "Reconcilia rupturas e solicitações automáticas.",
    OkSchema,
  ),
  "POST /admin/procurement/purchase-orders": admin(
    "createPurchaseOrder",
    "Procurement",
    "Cria um pedido de compra com cotações.",
    OkSchema,
    { body: PurchaseOrderInputSchema },
  ),
  "POST /admin/procurement/purchase-orders/:id/actions": admin(
    "actPurchaseOrder",
    "Procurement",
    "Submete, aprova, emite ou encerra um pedido.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedReasonActionSchema },
  ),
  "POST /admin/procurement/purchase-orders/:id/receipts": admin(
    "receivePurchaseOrder",
    "Procurement",
    "Registra recebimento e movimenta estoque atomicamente.",
    OkSchema,
    { params: IdParamsSchema, body: PurchaseReceiptInputSchema },
  ),
  "POST /admin/procurement/invoices": admin(
    "createProcurementInvoice",
    "Procurement",
    "Registra nota e executa a conferência financeira.",
    OkSchema,
    { body: ProcurementInvoiceInputSchema },
  ),
  "POST /admin/procurement/invoices/:id/actions": admin(
    "actProcurementInvoice",
    "Procurement",
    "Decide divergências e aprovação da nota.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedReasonActionSchema },
  ),
  "POST /admin/procurement/payables/:id/payments": admin(
    "payProcurementPayable",
    "Procurement",
    "Registra pagamento parcial e multimeios.",
    OkSchema,
    { params: IdParamsSchema, body: PaymentInputSchema },
  ),
  "GET /admin/inventory/lots": admin(
    "listInventoryLots",
    "Inventory",
    "Lista lotes e alertas de validade.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "POST /admin/inventory/products/:id/lot-tracking": admin(
    "configureLotTracking",
    "Inventory",
    "Configura rastreabilidade e saldo inicial por lote.",
    OkSchema,
    { params: IdParamsSchema, body: LotTrackingInputSchema },
  ),
  "POST /admin/inventory/lots/:id/actions": admin(
    "actInventoryLot",
    "Inventory",
    "Descarta ou ajusta um lote.",
    OkSchema,
    { params: IdParamsSchema, body: LotActionSchema },
  ),
  "GET /admin/minibar/compositions": admin(
    "listMinibarCompositions",
    "Minibar",
    "Lista composições versionadas de frigobar.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "POST /admin/minibar/compositions": admin(
    "createMinibarComposition",
    "Minibar",
    "Cria composição por tipo de quarto.",
    OkSchema,
    { body: MinibarCompositionInputSchema },
  ),
  "POST /admin/minibar/compositions/:id/versions": admin(
    "versionMinibarComposition",
    "Minibar",
    "Cria e opcionalmente ativa uma versão de composição.",
    OkSchema,
    { params: IdParamsSchema, body: MinibarCompositionVersionInputSchema },
  ),
  "GET /admin/minibar/replenishment-board": admin(
    "getMinibarReplenishmentBoard",
    "Minibar",
    "Consulta necessidades por quarto.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "POST /admin/minibar/replenishment-routes": admin(
    "createMinibarRoute",
    "Minibar",
    "Cria uma rota de separação e reposição.",
    OkSchema,
    { body: MinibarRouteInputSchema },
  ),
  "POST /admin/minibar/replenishment-routes/:id/actions": admin(
    "actMinibarRoute",
    "Minibar",
    "Assume, conclui ou cancela uma rota.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedReasonActionSchema },
  ),
  "GET /admin/cash-registers": admin(
    "listCashRegisters",
    "Cash",
  ...
  "POST /admin/cash-registers": admin(
    ...
    OkSchema,
    { body: CashRegisterInputSchema },
  ),
  "POST /admin/cash-registers/:id/sessions": admin(
    "openCashSession",
    "Cash",
    "Abre sessão exclusiva para o operador.",
    OkSchema,
    { params: IdParamsSchema, body: CashSessionOpenSchema },
  ),
  "GET /admin/cash-sessions/:id": admin(
    "getCashSession",
    "Cash",
    "Consulta uma sessão e seus movimentos.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema },
  ),
  "POST /admin/cash-sessions/:id/actions": admin(
    "actCashSession",
    "Cash",
    "Conta, aprova, transfere ou cancela uma sessão.",
    OkSchema,
    { params: IdParamsSchema, body: CashSessionActionSchema },
  ),
  "POST /admin/cash-sessions/:id/movements": admin(
    "postCashMovement",
    "Cash",
    "Registra suprimento, retirada, depósito ou ajuste.",
    OkSchema,
    { params: IdParamsSchema, body: CashMovementInputSchema },
  ),
  "GET /admin/daily-close/:businessDate": admin(
    "getDailyClose",
    "Daily close",
    "Consulta conferência da data operacional.",
    Type.Record(Type.String(), Type.Any()),
    { params: Type.Object({ businessDate: date() }, strict) },
  ),
  "POST /admin/daily-close/:businessDate/prepare": admin(
    "prepareDailyClose",
    "Daily close",
    "Prepara snapshot e fingerprint do fechamento.",
    OkSchema,
    {
      params: Type.Object({ businessDate: date() }, strict),
      body: DailyClosePrepareSchema,
    },
  ),
  "POST /admin/daily-close/:businessDate/actions": admin(
    "actDailyClose",
    "Daily close",
    "Aprova ou rejeita um fechamento preparado.",
    OkSchema,
    {
      params: Type.Object({ businessDate: date() }, strict),
      body: DailyCloseActionSchema,
    },
  ),
  "POST /admin/consumption/partner-settlements/:id/disputes": admin(
    "createPartnerDispute",
    "Partner settlements",
    "Contesta um componente da apuração.",
    OkSchema,
    { params: IdParamsSchema, body: PartnerDisputeInputSchema },
  ),
  "POST /admin/consumption/partner-settlements/:id/payments": admin(
    "payPartnerSettlementPartially",
    "Partner settlements",
    "Liquida parcialmente o saldo não contestado.",
    OkSchema,
    { params: IdParamsSchema, body: PaymentInputSchema },
  ),
  "POST /admin/consumption/partner-disputes/:id/actions": admin(
    "actPartnerDispute",
    "Partner settlements",
    "Resolve uma contestação de componente.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedReasonActionSchema },
  ),
  "GET /admin/rate-plans": admin(
    "listRatePlans",
    "Reservations",
    "Lista planos e versões tarifárias.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "POST /admin/rate-plans": admin(
    "createRatePlan",
    "Reservations",
    "Cria um plano tarifário em rascunho.",
    OkSchema,
    { body: RatePlanInputSchema },
  ),
  "POST /admin/rate-plans/:id/versions": admin(
    "createRatePlanVersion",
    "Reservations",
    "Cria uma versão imutável do plano.",
    OkSchema,
    { params: IdParamsSchema, body: RatePlanVersionInputSchema },
  ),
  "POST /admin/rate-plan-versions/:id/actions": admin(
    "actRatePlanVersion",
    "Reservations",
    "Ativa ou aposenta uma versão tarifária.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedBookingActionSchema },
  ),
  ...
  "POST /admin/reservations/:id/amendments/simulate": admin(
    "simulateReservationAmendment",
    "Reservations",
    "Simula alteração preservando diárias intactas.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema, body: ReservationAmendmentInputSchema },
  ),
  "POST /admin/reservations/:id/amendments": admin(
    "applyReservationAmendment",
    "Reservations",
    "Confirma alteração versionada da reserva.",
    OkSchema,
    { params: IdParamsSchema, body: ReservationAmendmentInputSchema },
  ),
  "POST /admin/reservations/:id/guarantees": admin(
    "recordReservationGuarantee",
    "Reservations",
    "Registra sinal ou dispensa auditada.",
    OkSchema,
    { params: IdParamsSchema, body: ReservationGuaranteeInputSchema },
  ),
  "POST /admin/reservations/:id/actions": admin(
    "actReservation",
    "Reservations",
    "Cancela a reserva ou registra no-show aplicando a política congelada.",
    OkSchema,
    { params: IdParamsSchema, body: VersionedBookingActionSchema },
  ),
  "POST /admin/reservations/:id/room-assignments/simulate": admin(
    "simulateRoomAssignment",
    "Reservations",
    "Sugere quartos compatíveis e disponíveis.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema, body: RoomAssignmentInputSchema },
  ),
  "POST /admin/reservations/:id/room-assignments": admin(
    "assignReservationRoom",
    "Reservations",
    "Aloca o quarto em transação única.",
    OkSchema,
    { params: IdParamsSchema, body: RoomAssignmentInputSchema },
  ),
  "GET /admin/prearrival/board": admin(
    "listPrearrivalBoard",
    "Pre-arrival",
    "Lista solicitações e chegadas que exigem ação.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "POST /admin/reservations/:id/prearrival-links": admin(
    "createPrearrivalLink",
    "Pre-arrival",
    "Revoga o link anterior e cria acesso temporário.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema, body: PrearrivalLinkInputSchema },
  ),
  "POST /admin/prearrival-requests/:id/actions": admin(
    "actPrearrivalRequest",
    "Pre-arrival",
    "Tria, decide, converte ou encerra uma solicitação.",
    OkSchema,
    { params: IdParamsSchema, body: PrearrivalRequestActionSchema },
  ),
  "GET /admin/customers/:id/relationship": admin(
    "getGuestRelationship",
    "Guest relationship",
    "Consulta histórico e preferências conforme a permissão.",
    Type.Record(Type.String(), Type.Any()),
    { params: IdParamsSchema },
  ),
  "POST /admin/customers/:id/preferences": admin(
    "createGuestPreference",
    "Guest relationship",
    "Registra uma preferência declarada e consentida.",
    OkSchema,
    { params: IdParamsSchema, body: GuestPreferenceInputSchema },
  ),
  "GET /admin/booking-configuration": admin(
    "getBookingConfiguration",
    "Booking",
    "Consulta a publicação da venda direta.",
    Type.Record(Type.String(), Type.Any()),
  ),
  "PUT /admin/booking-configuration": admin(
    "updateBookingConfiguration",
    "Booking",
    "Atualiza a configuração publicável do hotel.",
    OkSchema,
    { body: BookingConfigurationInputSchema },
  ),
  "GET /admin/booking-channels": admin(
    "listBookingChannels",
    "Booking channels",
  ...
  "POST /admin/booking-channels": admin(
    ...
    "Booking channels",
    "Cria uma conexão e retorna o segredo uma única vez.",
    OkSchema,
    { body: BookingChannelInputSchema },
  ),
  "POST /admin/booking-channels/:id/mappings": admin(
    "mapBookingChannel",
    "Booking channels",
    "Mapeia categoria e plano externos.",
    OkSchema,
    { params: IdParamsSchema, body: BookingChannelMappingInputSchema },
  ),
  "GET /admin/booking-channels/inbox": admin(
    "listBookingChannelInbox",
    "Booking channels",
  ...
  "GET /admin/analytics/operations": admin(
    ...
    "Analytics",
    "Compara previsão e realizado por data operacional.",
    Type.Record(Type.String(), Type.Any()),
    {
      querystring: Type.Object(
        { from: Type.Optional(date()), to: Type.Optional(date()) },
        strict,
      ),
    },
  ),
  "GET /admin/analytics/operations/drilldown": admin(
    "drilldownIntegratedAnalytics",
    "Analytics",
    "Abre os registros que compõem um indicador.",
    Type.Record(Type.String(), Type.Any()),
    {
      querystring: Type.Object({ date: date(), metric: Type.String() }, strict),
    },
  ),
  "POST /admin/analytics/operations/reconcile": admin(
    "reconcileIntegratedAnalytics",
    "Analytics",
    "Reconcilia fatos do hotel ativo.",
    OkSchema,
    {
      body: Type.Object(
        { from: Type.Optional(date()), to: Type.Optional(date()) },
