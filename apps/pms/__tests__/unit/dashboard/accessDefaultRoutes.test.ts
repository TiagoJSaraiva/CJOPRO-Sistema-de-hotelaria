...
import { getReservationsCalendarDefaultRoute, type ReservationsCalendarAccess } from "../../../src/app/dashboard/reservations/access";
...
describe("dashboard access default routes", () => {
  it("prioriza rota view quando canRead=true", () => {
    ...
    expect(getReservationsCalendarDefaultRoute({ canAccess: true } as ReservationsCalendarAccess)).toBe("/dashboard/reservations/view");
  });
