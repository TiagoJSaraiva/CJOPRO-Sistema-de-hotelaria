...
} from "../../../src/app/dashboard/rooms/_components/roomViewFilters";
import {
...
} from "../../../src/app/dashboard/seasons/_components/seasonViewFilters";
import {
...
describe("entity view filters", () => {
  it("filtra quartos por busca, status e capacidade", () => {
    ...
    const result = applyRoomViewFilters(rooms, {
      ...DEFAULT_ROOM_VIEW_FILTERS,
      search: "suite",
      status: "available",
      minOccupancy: "3",
  ...
  it("filtra clientes por busca, documento e nascimento", () => {
    ...
    const result = applyCustomerViewFilters(customers, {
      ...DEFAULT_CUSTOMER_VIEW_FILTERS,
      search: "maria",
      documentType: "CPF",
  ...
  it("filtra produtos por busca, status e faixa de preco", () => {
    ...
    const result = applyProductViewFilters(products, {
      ...DEFAULT_PRODUCT_VIEW_FILTERS,
      search: "cafe",
      status: "active",
      minPrice: "10",
  ...
  it("filtra temporadas por nome, status e data", () => {
    ...
    const result = applySeasonViewFilters(seasons, {
      ...DEFAULT_SEASON_VIEW_FILTERS,
      search: "alta",
      status: "active",
      startFrom: "2026-12-01",
    });
  ...
  it("filtra tarifas por temporada por sala, temporada e faixa de preco", () => {
    ...
    const result = applySeasonRoomRateViewFilters(items, {
      ...DEFAULT_SEASON_ROOM_RATE_VIEW_FILTERS,
      search: "suite",
      seasonId: "s1",
      minRate: "200",
