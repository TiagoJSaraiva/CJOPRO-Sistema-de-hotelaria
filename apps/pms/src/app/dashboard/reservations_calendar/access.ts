...
export function getReservationsCalendarDefaultRoute(access: ReservationsCalendarAccess): "/dashboard/reservations_calendar/view" | null {
  if (access.canAccess) {
    return "/dashboard/reservations_calendar/view";
  }
