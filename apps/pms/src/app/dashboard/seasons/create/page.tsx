...
export default async function SeasonsCreatePage({
  searchParams,
}: SeasonsCreatePageProps) {
  ...
  if (!access.canCreate) {
    ...
    return (
      <DashboardAccessDeniedCard
        title="Temporadas"
        message="Sem permissão para criar temporada."
      />
    );
  }
