...
const statusMessages: Record<string, string> = {
  ...
  create_missing_fields: "Preencha tipo, categoria, valor, moeda, datas e vínculos válidos para criar lançamento.",
  update_missing_fields: "Preencha id, tipo, categoria, valor, moeda, datas e vínculos válidos para atualizar lançamento.",
