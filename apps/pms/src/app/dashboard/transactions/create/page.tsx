...
export default async function TransactionsCreatePage({
  searchParams,
}: TransactionsCreatePageProps) {
  ...
  if (!access.canCreate) {
    ...
    return (
      <DashboardAccessDeniedCard
        ...
        message="Sem permissão para criar lançamento financeiro."
      />
    );
  }
      ...
      >
        ...
        <FormField label="Categoria" htmlFor="create-transaction-category">
          <input
            ...
            name="category"
            required
            placeholder="Ex.: Manutenção, lavanderia"
            className="pms-field-input"
          />
        </FormField>

        <FormField
          label="Fornecedor ou favorecido"
          htmlFor="create-transaction-counterparty"
        >
          <input
            id="create-transaction-counterparty"
            name="counterparty"
            placeholder="Ex.: Energia SP"
            className="pms-field-input"
          />
        </FormField>
        ...
        <FormField
          ...
          htmlFor="create-transaction-cost-center"
        >
          <input
            id="create-transaction-cost-center"
            name="cost_center"
            placeholder="Ex.: Operação, Governança"
            className="pms-field-input"
          />
        </FormField>
        ...
        <FormField label="Vencimento" htmlFor="create-transaction-due-date">
          <input
            id="create-transaction-due-date"
            name="due_date"
            type="date"
            className="pms-field-input"
          />
        ...
        <FormField
          ...
          htmlFor="create-transaction-payment-method"
        >
          <input
            id="create-transaction-payment-method"
            name="payment_method"
        ...
        <FormField
          ...
          htmlFor="create-transaction-reference-code"
        >
          <input
            id="create-transaction-reference-code"
            name="reference_code"
            placeholder="NF, recibo, pedido interno"
            className="pms-field-input"
          />
        </FormField>
        ...
        <FormField
          ...
          htmlFor="create-transaction-reservation-id"
        >
          <input
            id="create-transaction-reservation-id"
            name="reservation_id"
            placeholder="UUID da reserva, se houver"
            className="pms-field-input"
          />
        </FormField>

        <FormField
          label="Estadia vinculada"
          htmlFor="create-transaction-stay-id"
        >
          <input
            id="create-transaction-stay-id"
            name="stay_id"
            placeholder="UUID da estadia, se houver"
            className="pms-field-input"
          />
        </FormField>
        ...
        <FormField
          label="Descrição"
          htmlFor="create-transaction-description"
          fullWidth
        >
          <input
            id="create-transaction-description"
            name="description"
            placeholder="Observações operacionais, aprovador ou contexto"
            className="pms-field-input"
          />
        </FormField>
      </DashboardCreateFormCard>
