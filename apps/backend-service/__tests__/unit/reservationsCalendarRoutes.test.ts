...
function createRepositoryMock(overrides: Partial<ReservationsCalendarRepository> = {}): ReservationsCalendarRepository {
  return {
...
describe("routes/reservations/calendar", () => {
  ...
  it("retorna timeline com intervalo calculado", async () => {
    ...
    expect(repository.getTimeline).toHaveBeenCalledWith("hotel-1", "2026-05-06", "2026-05-25");
  });
});
